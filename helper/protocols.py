...
def ethernet_frame(data):
    dest_mac. mac_src , eth_protocol = struct.unpack('!6s6sH', data[:14])
...
def ipv6_packet(data):
    ...
    ipv6_first_word, payload_length, protocol , hoplimit = struct.unpack(">IHBB", data[0:8])
    ...
    traffic_class = int(ipv6_first_word >> 16) & 4096
    flow_label = int(ipv6_first_word) & 65535

    return src_ip, dst_ip, protcol, data[40:]
